...
<body>
<form action="<c:url value='userpay_list.do'/>" name="form" id="form" method="post">
                        ...
                        <td style="padding-top:0px;padding-left:6px;padding-right:6px;padding-bottom:8px;">
                            <table width="100%" cellpadding="2" cellspacing="0" class="dataTable" id="dg1">
                                <tr class="dataTableHead">
                                    ...
                                    <td width="15%"><b>支付名称</b></td>
                                    <td width="10%"><b>支付金额</b></td>
                                    <td width="10%"><b>支付状态</b></td>
                                    <td width="20%"><b>创建时间</b></td>
                                    <td width="20%"><b>过期时间</b></td>
                                ...
                                <c:if test="${!empty pagination.list}">
                                    <c:forEach items="${pagination.list}" var="item">
                                        <tr style="background-color:#F9FBFC">
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${item.payStatus=='1'}">成功</c:when>
                                ...
                                <tr>
                                    <td colspan="7" align="center" id="dg1_PageBar">
                                        <pg:zPage baseurl="userpay_list.do?userId=${userId}" pagination="${pagination}"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
