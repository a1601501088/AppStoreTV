...
@Controller
public class UserPackVipAction extends BaseAction {
    private Log log = LogFactory.getLog(UserPackVipAction.class);
     ...
     * @modify
     */
    @RequestMapping("/system/app/packagevip_list")
    public String findlList(String page, HttpServletRequest request){
        try {
            ...
            //构建分页对象
            Pagination pagination = findPageList(map, userPVipServ, currentPage, 15);
            //绑定到页面
        ...
        return directReturn("/system/app/packagevip_list.jsp");
    }
}
